	...
	\begin{center}
		\resizebox{\columnwidth}{!}{%
			\begin{tabular}{ccccc}
				...
				1 & \begin{tabular}[c]{@{}c@{}}Min. Active Power \\ Loss\end{tabular} & Peak Load for Test    & Single   & 5-Bus  \\ 
				2 & \begin{tabular}[c]{@{}c@{}}Min. Active Power \\ Loss\end{tabular} & Peak Load (1 Hour)    & Multiple & 33-Bus \\ 
				3 & Min. Energy Loss                                                  & Multi-Level (3 Hours) & Multiple & 33-Bus \\ 
				4 & Min. Energy Loss                                                  & Daily (24 Hours)      & Multiple & 33-Bus \\ 
				5 & Min. Energy Loss                                                  & Seasonal (96 Hours)   & Multiple & 33-Bus \\ \hline
...
%				2016 [5]            & BFOA           & 6          & 2200.000          & 113.140          \\
%				2016 [11]           & HSA-PABC       & 6          & 2598.000          & 111.030          \\
%				2017 [8]            & FPA            & 7          & 2000.000          & 112.100          \\
%				2017 [14]           & GWO            & 6          & 2761.820          & 111.420          \\
%				2018 [2]            & GA             & 6          & 2600.000          & 111.030          \\
%				2018 [4]            & DA             & 6          & 2590.200          & 111.034          \\
%				2021 [10]           & MRFO           & 6          & 2590.217          & 111.027          \\
%				2021 [13]           & PFA            & 6          & 2590.264          & 111.030          \\
%				2022 [9]            & HBA            & 30         & 1542.000          & 125.000          \\
%				\textbf{This Study} & \textbf{WOA}   & \textbf{6} & \textbf{2590.217} & \textbf{111.019} \\
%				\textbf{This Study} & \textbf{E-WOA} & \textbf{6} & \textbf{2590.217} & \textbf{111.019} \\ \hline
%			\end{tabular}%
%		}
...
%				1035.300 &
%				72.8760 \\
%				\textbf{\begin{tabular}[c]{@{}c@{}}This \\ Study\end{tabular}} &
%				\textbf{WOA} &
%				\textbf{13, 24, 30} &
%				\textbf{799.830} &
%				\textbf{1047.810} &
	...
	\begin{center}
		\resizebox{\columnwidth}{!}{%
			\begin{tabular}{ccccccc}
				...
				Case 1         & \multicolumn{4}{l}{\textit{5-Bus Test System With 1 DG at Peak Load}}                                                                  & kW               \\
				Base           & -                               & -                             & -                            & -                            & 0.358            \\
				WOA            & 4                               & 201.833                       &                              &                              & 0.059            \\
				\textbf{E-WOA} & \textbf{4}                      & \textbf{201.833}              & \textbf{}                    & \textbf{}                    & \textbf{0.059}   \\ \hline
				Case 2         & \multicolumn{4}{l}{\textit{33-Bus Test System With at Most 3 DGs at Peak Load}}                                                        & kW               \\
				Base           & -                               & -                             & -                            & -                            & 169.389          \\
				...
				Case 3         & \multicolumn{4}{l}{\begin{tabular}[c]{@{}l@{}}\textit{33-Bus Test System With at Most 3 DGs Across} \\ \textit{3 Loading Levels}\end{tabular}}  & kWh              \\
				Base           & -                               & -                             & -                            & -                            & 216.017          \\
				...
				Case 4         & \multicolumn{4}{l}{\begin{tabular}[c]{@{}l@{}}\textit{33-Bus Test System With at Most 3 DGs Across} \\ \textit{24 Loading Levels}\end{tabular}} & kWh              \\
				Base           & -                               & -                             & -                            & -                            & 1598.547         \\
				...
				Case 5         & \multicolumn{4}{l}{\begin{tabular}[c]{@{}l@{}}\textit{33-Bus Test System With at Most 3 DGs Across} \\ \textit{96 Loading Levels}\end{tabular}} & kWh              \\
				Base           & -                               & -                             & -                            & -                            & 3765.261         \\
				\textbf{WOA}   & \textbf{6, 8, 14}               & \textbf{908.942}              & \textbf{745.308}             & \textbf{831.379}             & \textbf{647.610} \\
				E-WOA          &                                 & \multicolumn{3}{c}{No Solutions Found}                                                      &                  \\ \hline
			\end{tabular}%
		}
	...
	\begin{center}
		\resizebox{\columnwidth}{!}{%
			\begin{tabular}{ccccccc}
				...
				Case 1 & 0.0589   & 0.0589   & 2.53e-15 & 2.00e-17 & 0.0589   & 0.0589   \\
				Case 2 & 14.6446  & 11.7118  & 2.5773   & 1.0800   & 11.3111  & 11.3073  \\
				Case 3 & 30.5655  & 16.2833  & 5.9251   & 3.7039   & 15.4794  & 14.4691  \\
				Case 4 & 349.2446 & 257.4618 & 146.3024 & 32.8077  & 221.8375 & 168.2436 \\
				Case 5 & 917.1043 & -        & 550.9331 & -        & 647.6101 & -        \\ \hline
			\end{tabular}%
		}
...
\begin{figure}[htbp]
	\centerline{\includegraphics[width=0.46\textwidth]{objectivefunction.png}}
	\vspace{-5pt}
	\caption{Box Plot Comparison of the Normalized Objective Function Value Obtained by WOA and E-WOA for Cases 1-5.}
	\vspace{-5pt}
...
%				\textbf{Case 3} &
%				\textbf{Case 4} &
%				\textbf{Case 5} \\ \cline{3-7} 
%				\multirow{3}{*}{\begin{tabular}[c]{@{}c@{}}Case \\ Specs.\end{tabular}} &
%				Buses &
%				5 &
%				33 &
%				33 &
...
%				3 \\
%				&
%				\begin{tabular}[c]{@{}c@{}}Size/\\ Dispatcha\end{tabular} &
%				1 &
%				3 &
%				9 &
%				72 &
...
%				\textbf{75} &
%				\textbf{291} \\ \hline
%				\multirow{4}{*}{\begin{tabular}[c]{@{}c@{}}Mean\\ (s)\end{tabular}} &
%				\multirow{2}{*}{WOA} &
%				\textbf{0.57} &
%				\textbf{9.51} &
%				\textbf{23.949} &
...
%				776\% &
%				\sout{102\%} \\ \hline
%				\multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}Min.\\ (s)\end{tabular}} &
%				WOA &
%				\textbf{0.5610} &
%				\textbf{7.66} &
%				\textbf{16.90} &
...
%				25.30 &
%				204.11 &
%				\sout{\textbf{382.12}} \\ \hline
%				\multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}Max.\\ (s)\end{tabular}} &
%				WOA &
%				\textbf{0.6702} &
%				\textbf{10.93} &
%				\textbf{27.71} &
	...
	\begin{center}
		\resizebox{\columnwidth}{!}{%
			\begin{tabular}{ccccccc}
				...
				\textbf{Case 4} &
				\textbf{Case 5} \\ \cline{3-7} 
				\multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}Case \\ Specs.\end{tabular}} &
				DGs &
				1 &
				3 &
				3 &
				...
				3 \\
				&
				\begin{tabular}[c]{@{}c@{}}Size/\\ Dispatch$^{\mathrm{a}}$\end{tabular} &
				1 &
				3 &
				9 &
				72 &
				...
				776\% &
				\sout{102\%} \\ \hline
				\multicolumn{7}{l}{$^{\mathrm{a}}${Dispatch = (No. of DGs) * (No. of Hours).}} \\
				\multicolumn{7}{l}{$^{\mathrm{b}}${Average runtime is irrelevant for comparison since no feasible solutions}} \\
				\multicolumn{7}{l}{were found.} \\
...
%The results demonstrate that both WOA and E-WOA are effective in solving the ODGA problem, with E-WOA performing on par with or better than recent improved and hybrid optimization algorithms in finding the global optimum. An in-depth comparison reveals the impact of E-WOA's improved search strategies and population diversity. These enable E-WOA to consistently find high-quality solutions for problems with few variables. However, these enhancements lead to longer runtimes, slower convergence for large problems, worse constraint handling, and poor scalability, failing to find feasible solutions in large-scale problems. While E-WOA outperforms WOA in smaller cases, its advantages diminish as problem complexity increases.
%
%Future work should explore further improvements to E-WOA to enhance its performance in large-scale optimization tasks. Considering different distribution system topologies including large-scale and three-phase unbalanced systems could further provide insights into EWOA’s performance. Additionally, using load datasets incorporating modern demand patterns like electric vehicles and demand response, as well as including renewable generation profiles would further improve the study’s accuracy and relevance. 
%\section*{References}
...
%citation first, followed by the original foreign-language citation \cite{Ausgrid_solar_2023}.
\vspace{-15pt}
